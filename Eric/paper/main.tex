...
\addbibresource{references.bib} % including the bib resource
% to cite references use either \autocite{reference_name}
% or \textcite{reference_name}
% there are additional alternatives if these are not the style you want
